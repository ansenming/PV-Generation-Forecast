...
data_raw = np.zeros((48306,7),dtype = np.float32)
data_ripe = np.zeros((3216,7), dtype = np.float32)
...
#--------------------------------------------------
#最後兩天當testing data
x_train = np.zeros((3120,6),dtype = np.float32)
y_train = np.zeros((3120,),dtype = np.float32)
x_test = np.zeros((96,6), dtype = np.float32)
y_test = np.zeros((96,), dtype = np.float32)

x_train = data_ripe[:3120,0:6]
y_train = data_ripe[:3120, 6]
x_test = data_ripe[3120:, 0:6]
y_test = data_ripe[3120:, 6]
